...
actual = conv(x_polar, h);
actual = downsample([zeros(1,11) actual],12);
...
function out = mux(mux_index, counter, bit)
    muxes = [-6 6 -16 16 -31 31 -52 52 -81 81 -114 114 -148 148 -179 179 -198 198 -197 197 -166 166 -97 97;
         ...
         -97 97 -166 166 -197 197 -198 198 -179 179 -148 148 -114 114 -81 81 -52 52 -31 31 -16 16 -6 6];
    index = counter*2+bit;
